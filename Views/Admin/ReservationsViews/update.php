	...
	<form action="#" method="post">
		...
		<input type="text" name="hostelName" id="">	
		</div>
		...
		<div class="rating">
				...
				<label>
					<input type="radio" name="hostelStars" value="1" />
					<span class="icon">★</span>
				</label>
				<label>
					<input type="radio" name="hostelStars" value="2" />
					<span class="icon">★</span>
					<span class="icon">★</span>
				</label>
				<label>
					<input type="radio" name="hostelStars" value="3" />
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>   
				</label>
				<label>
					<input type="radio" name="hostelStars" value="4" />
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
				...
				<label>
					<input type="radio" name="hostelStars" value="5" />
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
				...
				<label>
					<input type="radio" name="hostelStars" value="6" />
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
				...
				<label>
					<input type="radio" name="hostelStars" value="7" />
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
					<span class="icon">★</span>
		...
		<div class="FormHostelAdress FormHostelGroups">
			...
			<div class="FormHostelAdressStreet">
				<label for="">Rue :</label>
				<input type="text" name="add_streetName" id="">			
			</div>


			<div class="FormHostelAdressNumber">
				<label for="">Numéro:</label>
				<input type="text" name="add_number" id="">			
			</div>
